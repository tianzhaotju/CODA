...
####  (1) Comparison results of RFR across all the subjects.
<img src="./figs/rfr.png" alt="drawing" width="1000">

--- --- ---



####  (2) Comparison results of PCD and invocations on testing CodeBERT, GraphCodeBERT, and CodeT5.
...
####  (3) Robustness enhancement of the target models after adversarial fine-tuning.
...
####  (4) We investigated the contribution of each main component in CODA, including reference inputs selection (RIS), equivalent structure transformations (EST), and identifier renaming transformations (IRT).
...
####  (5) Experimental results of the user study to evaluate naturalness of adversarial examples generated by three techniques. 
...
#### (6) The influence of U in terms of average RFR across all the subjects.
...
#### (7) The influence of N in terms of average RFR across all the subjects.
